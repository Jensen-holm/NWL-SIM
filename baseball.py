...
# honestly this should just be a function not a class
    ...
    def __init__(self):
        ...
        if self.lineup_optimizer == 'y':
            # prompt to select which bullpen pitchers the other team will use as well once we get that incorperated
                ...
                team1 = NWLTeam(self.level, 'opt', self.team2_name, data1[0][0], data1[0][1], data1[0][2], data1[0][3])
                team2 = NWLTeam(self.level, 'opt', self.team2_name, data2[0][0], data2[0][1], data2[0][2], data2[0][3])
                print('\n')
            ...
            if self.situational == 'y':
                ...
                team1 = NWLTeam(self.level, 'manual', self.team1_name)
                team2 = NWLTeam(self.level, 'manual', self.team2_name)
                ...
                team1 = NWLTeam(self.level, self.lineup_settings, self.team1_name, data1[0][0], data1[0][1], data1[0][2], data1[0][3])
                team2 = NWLTeam(self.level, self.lineup_settings, self.team2_name, data2[0][0], data2[0][1], data2[0][2], data2[0][3])
